...
try{
    ...
    $insertdata = "INSERT INTO issues(title,descrip,typeof,priority,stat,assigned_to,created_by, created,updated) VALUES('$title','$descrip','$typeof','$priority','$stat','$assign','$assign',NOW(),NOW())";
